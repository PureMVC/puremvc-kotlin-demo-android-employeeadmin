...
@Parcelize
data class UserVO(val username: String, var first: String, var last: String, var email: String, var password: String, var department: DeptEnum = DeptEnum.NONE_SELECTED): Parcelable {
